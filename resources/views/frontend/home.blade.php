						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="box-item">
									...
									<img src="public/frontend/images/menu.jpg" alt="">
						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="box-item">
									...
									<img src="public/frontend/images/fast-food.jpg" alt="">
									<p>The sliding menucard will surely impress your customers! Set up several pages and display them side by side, just as on a paper menucard!</p>
									<a href="#" class="button button-1">Detail</a>
								</div>
							</div>
						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="box-item">
									...
									<img src="public/frontend/images/reservation.jpg" alt="">
									<p>The sliding menucard will surely impress your customers! Set up several pages and display them side by side, just as on a paper menucard!</p>
									<a href="#" class="button button-1">Detail</a>
								</div>
							</div>
						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="box-item">
									...
									<img src="public/frontend/images/chef.jpg" alt="">
									<p>The sliding menucard will surely impress your customers! Set up several pages and display them side by side, just as on a paper menucard!</p>
									<a href="#" class="button button-1">Detail</a>
								</div>
							</div>
						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="box-item">
									...
									<img src="public/frontend/images/preview.jpg" alt="">
									<p>The sliding menucard will surely impress your customers! Set up several pages and display them side by side, just as on a paper menucard!</p>
									<a href="#" class="button button-1">Detail</a>
								</div>
							</div>
