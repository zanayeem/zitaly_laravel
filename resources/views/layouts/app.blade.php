    ...
    <section class="vbox">
        <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
            <div class="navbar-header aside-md dk">
                ...
                <a href="index.html" class="navbar-brand"> <img src="public/frontend/images/logo.png" class="m-r-sm" alt="scale"> <span class="hidden-nav-xs">ZItaly</span> </a>
            ...
            <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                    ...
                    <section class="dropdown-menu aside-xl animated flipInY">
                        <section class="panel bg-white">
                            ...
                            <div class="list-group list-group-alt">
                                <a href="#" class="media list-group-item"> <span class="pull-left thumb-sm"> <img src="public/backend/images/a0.png" alt="..." class="img-circle"> </span> <span class="media-body block m-b-none"> Use awesome animate.css<br> <small class="text-muted">10 minutes ago</small> </span> </a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="public/backend/images/a0.png" alt="..."> </span> {{Auth::user()-> name}}<b class="caret"></b> </a>
                        ...
                        <section class="w-f scrollable">
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                <div class="clearfix wrapper dk nav-user hidden-xs">
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb avatar pull-left m-r"> <img src="public/backend/images/a0.png" class="dker" alt="..."> <i class="on md b-black"></i> </span> <span class="hidden-nav-xs clear"> <span class="block m-t-xs"> <strong class="font-bold text-lt">{{Auth::user()->name}}</strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Full Stack Web Developer</span> </span>
                                        </a>
